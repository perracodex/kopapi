 ...
 *          - Traverse Property Type: Uses `TypeSchemaResolver` to traverse the property's type.
 ...
 */
@TypeInspectorAPI
internal class PropertyResolver(private val typeSchemaResolver: TypeSchemaResolver) {
