...
- `TypeInspector`: The entry point that initiates the inspection process for a given type.
- `TypeSchemaBuilder`: The core orchestrator delegating to specific resolvers based on the type characteristics.
